...
OUTPUT="$("$ROOT/build/recovered-primitives" --time-seconds=1760000001)"
printf '%s\n' "$OUTPUT"
...
NO_TRAMPOLINE_OUTPUT="$("$ROOT/build/recovered-primitives" --signer-code-trampoline-detected=false)"
...
NO_CORRECTION_05_OUTPUT="$("$ROOT/build/recovered-primitives" \
...
EMPTY_PROC_MAPS_OUTPUT="$("$ROOT/build/recovered-primitives" --correction-codes=2b,37,36,25,05)"
...
MISSING_PROC_MAPS_OUTPUT="$("$ROOT/build/recovered-primitives" --correction-codes=2b,37,35,36,25,05)"
...
ALT_DEVICE_NAME_OUTPUT="$("$ROOT/build/recovered-primitives" --native-plaintext-hex="$ALT_DEVICE_NAME_PLAINTEXT_HEX")"
...
MISSING_FIELDS_OUTPUT="$("$ROOT/build/recovered-primitives" --native-plaintext-hex="$MISSING_FIELDS_PLAINTEXT_HEX")"
...
ALT_CERTIFICATE_OUTPUT="$("$ROOT/build/recovered-primitives" \
...
CMDLINE_MISMATCH_OUTPUT="$("$ROOT/build/recovered-primitives" --correction-codes=2b,09,3c,36,25,05)"
...
MISSING_CMDLINE_OUTPUT="$("$ROOT/build/recovered-primitives" --correction-codes=2b,34,3c,36,25,05)"
...
NINE_CORRECTIONS_OUTPUT="$("$ROOT/build/recovered-primitives" \
  --certificate-sha1=18eb38693ef45c932340d8e8e23d6dfd3770c54c \
...
SEVENTEEN_CORRECTIONS_OUTPUT="$("$ROOT/build/recovered-primitives" \
